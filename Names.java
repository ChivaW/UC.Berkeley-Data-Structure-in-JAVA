 ...
 */
  public static void main(String arg[]) {
    ...
    System.out.println();
    System.out.println(first + " " + middle + " " + last + " "); //print: John Fitzgerald Kennedy
    System.out.println(initials); //JFK
    System.out.println(last + ", " + first + " " + middle); //print: Kennedy John Fitzgerald
    System.out.println(last + ", " + first + " " + middleInit +"."); //print: Kennedy John F.
    System.out.println(first.toUpperCase() + " " + last.toUpperCase()); //print: JOHN KENNEDY

    System.out.println(first + " equals john is " + first.equals("john")); //false
    System.out.println(first + " equals john (ignoring case) is " 
		       + first.equalsIgnoreCase("john")); //true
